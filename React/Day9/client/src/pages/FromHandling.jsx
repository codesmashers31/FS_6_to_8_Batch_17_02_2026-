...
const handleSubmit = (e)=>{
    ...
    e.preventDefault()
        ...
        localStorage.setItem("taskList",JSON.stringify(formData))
   ...
   <div className="p-8 bg-indigo-200 flex justify-center items-center from-blue-50 to-indigo-50 min-h-screen">
    ...
    <div className="p-10 bg-white rounded h-100 flex items-center w-180">
        ...
        <form className="p-2 flex flex-col gap-5" onSubmit={handleSubmit}>
             ...
             <input type="text" name="username" value={formData.username} onChange={handleChange}  placeholder="Enter the Name" className="border border-blue-500 rounded w-70 p-2" />
             ...
             <input type="text" name="mobile"   value={formData.mobile}   onChange={handleChange}  placeholder="Enter the Mobile" className="border border-blue-500 rounded w-70 p-2" />
             <input type="text" name="age"      value={formData.age}    onChange={handleChange}  placeholder="Enter the Age" className="border border-blue-500 rounded w-70 p-2" />
